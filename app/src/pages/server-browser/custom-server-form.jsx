...
import { Form, FormGroup, FormControl, Button, Col, FormLabel } from 'react-bootstrap';
        ...
        <Form horizontal onSubmit={this.onSubmit}>
          ...
          <FormGroup>
            <Col smOffset={2} sm={10}>
              <Button type="submit" variant="primary" disabled={!(this.state.host && this.state.username)}>Connect</Button>
            </Col>
          </FormGroup>
        </Form>
      </div>
